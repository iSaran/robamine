...
if __name__ == '__main__':
    ...
    world = World.create(DDPGParams(), 'Pendulum-v0')
    logger.info('Parameters of initial world before training')
    logger.info(world.agent.sess.run(world.agent.actor.trainable_params))
    world.train(n_episodes=2)
    logger.info('Parameters of initial world after training')
    logger.info(world.agent.sess.run(world.agent.actor.trainable_params))
    world.agent.save('/home/iason/hahahah.pkl')
#
