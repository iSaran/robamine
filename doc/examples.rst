...
In `rlrl_py/examples` directory you can find some examples to run. For example there for training and evaluating the DDPG algorithm with the Pendulum environment.
