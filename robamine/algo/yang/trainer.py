...
from robamine.algo.yang.models import reinforcement_net
...
class Trainer(object):
    ...
    def get_label_value(self, primitive_action, motion_target_oriented, env_change_detected, push_effective,
                        target_grasped, next_color_heightmap, next_depth_heightmap, next_mask_heightmap):
        ...
        print('Expected reward: %f + %f x %f = %f' % (current_reward, self.future_reward_discount, future_reward,
                                                      expected_reward))
