...
class LwrfInfer:
    def __init__(self, use_cuda, save_path=None):
        ...
        # hard-coded paths
        weights_path = '/home/mkiatos/Desktop/grasping-invisible-master/light_weight_refinenet/resnet50.pth.tar'
        self.color_map = np.load('/home/mkiatos/Desktop/grasping-invisible-master/light_weight_refinenet/utils/color_map.npy')
        self.class_map = np.load('/home/mkiatos/Desktop/grasping-invisible-master/light_weight_refinenet/utils/class_map.npy', allow_pickle=True).item()
